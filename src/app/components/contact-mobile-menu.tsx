  ...
  return (
    <>
      ...
      <div className="container mx-auto flex flex-col items-center md:flex-row md:space-x-8">
        ...
        <div className="border-4 border-orange-500 text-orange-500 rounded-3xl w-3/4 p-4 md:basis-1/2 md:h-32">
        ...
        <div className="w-3/4 md:basis-1/2 md:h-32 group">
          <div className="flex flex-row justify-center items-center border-4 border-lime-400 rounded-3xl p-9">
            <div className="mr-3">
              <svg 
